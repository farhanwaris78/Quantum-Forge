...
import quantumforge.app.project.editor.input.band.QEFXBand;
import quantumforge.app.project.editor.input.convergence.QEFXConvergence;
import quantumforge.app.project.editor.input.dos.QEFXDos;
import quantumforge.app.project.editor.input.geom.QEFXGeom;
import quantumforge.app.project.editor.input.md.QEFXMd;
import quantumforge.app.project.editor.input.neb.QEFXNeb;
import quantumforge.app.project.editor.input.opt.QEFXOpt;
import quantumforge.app.project.editor.input.phonon.QEFXPhonon;
import quantumforge.app.project.editor.input.scf.QEFXScf;
import quantumforge.app.project.editor.input.tddft.QEFXTddft;
...
public class InputEditorActions extends EditorActions {
    ...
    private static final String[] EDITOR_ITEMS = {
            "Geometry", "SCF", "Optimize", "MD", "DOS", "Band", "NEB", "TD-DFT", "Phonon", "Convergence" };
    ...
    private static final int[] EDITOR_INPUT_MODE = {
            ...
            Project.INPUT_MODE_CONVERGENCE
    };
    ...
    private void createComponents() throws IOException {
        ...
        if (mainController != null) {
            ...
            input = this.project == null ? null : this.project.getQEInputGeometry();
            if (input != null) {
                this.components.put(EDITOR_ITEMS[9], new QEFXConvergence(mainController, input));
            }
        }
    }
