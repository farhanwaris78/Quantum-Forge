...
updated, per project rules. Open QE-integration follow-ups now live outside
this table: per-program deck-builder GUI forms for the 24 auxiliary programs
(the frontend half named in the R7 row) and the standing packaging items.
